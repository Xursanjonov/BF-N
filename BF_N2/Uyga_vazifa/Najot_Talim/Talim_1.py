...
class Najot_Talim(QWidget):
    def __init__(self) -> None:
        ...
        self.btn_1 = QPushButton('Exit')
        self.btn_1.setShortcut('Ctrl+z')
        self.btn_1.setFixedSize(100,50)
        self.btn_1.setStyleSheet('background: red; border-radius: 10px; color: white; font-size: 18px')
        ...
        self.btn_1.clicked.connect(self.exit_d)
...
Bootcamp Result kursimiz 
        ...
        self.btns_1.setShortcut('Ctrl+z')
        self.btns_2 = Button_gold('Back')
        self.btns_2.setShortcut('Ctrl+x')
        self.btns_3 = Button('Next')
        self.btns_3.setShortcut('Ctrl+c')
...
🔰 Agar oldingi kompyuteringiz bo`lsa uning texnik holatini quyidagilarga keltirib olishingiz maqsadga muvofiq:
    ...
    - Agar HDD xotira bo`lsa, uni kamida 256GB SSDga almashtirish yoki HDD yoniga o`rnatish''')
        ...
        self.btn_BF_1.setShortcut('ctrl+z')
...
🔰 Agar oldingi kompyuteringiz bo`lsa uning texnik holatini quyidagilarga keltirib olishingiz maqsadga muvofiq:
    ...
    - Agar HDD xotira bo`lsa, uni kamida 256GB SSDga almashtirish yoki HDD yoniga o`rnatish''')
        ...
        self.btn_br_1.setShortcut('ctrl+z')
        self.btn_br_2 = Button_gold('Menyu')
        self.btn_br_2.setShortcut('ctrl+x')
